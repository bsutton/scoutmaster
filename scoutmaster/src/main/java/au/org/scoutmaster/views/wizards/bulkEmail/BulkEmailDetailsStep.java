...
public class BulkEmailDetailsStep implements WizardStep
{
	...
	private void attachFile(File file)
	{
		...
		BulkEmailDetailsStep.this.attachedFiles.addComponent(line);
		...
		removeButton.addClickListener(new ClickEventLogged.ClickListener()
		{
			...
			public void clicked(ClickEvent event)
			{
				...
				file.remove();
				BulkEmailDetailsStep.this.fileList.remove(file);
