...
//		googleMap.addMarker("DRAGGABLE: Kakolan vankila", new LatLon(60.44291, 22.242415), true);
//		googleMap.addMarker("NOT DRAGGABLE: Iso-Heikkilä", new LatLon(60.450403, 22.230399), false);
...
//		{
//			@Override
//			public void mapMoved(double zoomLevel, LatLon center, LatLon boundsNE, LatLon boundsSW)
//			{
...
//			{
//				Label consoleEntry = new Label("Marker \"" + draggedMarker.getCaption() + "\" dragged to ("
...
//					public void buttonClick(ClickEvent event)
//					{
//						googleMap.setCenterBoundLimits(new LatLon(60.619324, 22.712753), new LatLon(60.373484,
//								21.945083));
...
//				"Limit visible area between (60.494439, 22.397835), (60.373484, 21.945083)", new Button.ClickListener()
//				{
//					/**
//					 * 
//					 */
...
//					public void buttonClick(ClickEvent event)
//					{
//						googleMap.setVisibleAreaBoundLimits(new LatLon(60.494439, 22.397835), new LatLon(60.420632,
//								22.138626));
//						event.getButton().setEnabled(false);
//					}
//				});
