...
public class AppointmentView extends VerticalLayout implements View
{
	...
	public void enter(ViewChangeEvent event)
	{
		...
		final JPAContainer<au.com.noojee.scouts.domain.Event> container = JPAContainerFactory.make(
				au.com.noojee.scouts.domain.Event.class, "scouts");
		EntityProvider<au.com.noojee.scouts.domain.Event> ep = container.getEntityProvider();
...
//			{
//				au.com.noojee.scouts.domain.Event entity = new au.com.noojee.scouts.domain.Event(event.getCaption(),
